...
export default class BuyClothesList extends Component {
  constructor(){
    super();
  }
      ...
      <View>
        ...
        <View>
            <FlatList
              ...
              data={shopClothesImgData}
              renderItem={
                ({item}) => (
                <TouchableOpacity onPress={()=>{this.props.navigation.navigate('ShopClothesInfo',{shopId:item.shopId})}}>
